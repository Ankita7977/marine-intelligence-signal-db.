...
This document explains how the datasets used in the Marine Intelligence system are verified before they are stored in the database.

The purpose of this verification is to ensure that the data comes from trusted sources and follows the correct format.
...
These datasets are converted into a common schema before being stored in the **marine_signals** table.
...
Before ingestion, all datasets are checked to ensure they contain the required columns.
